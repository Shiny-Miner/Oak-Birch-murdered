...
# Link first.o (and standard libs) to first.elf gba_hack.specs
/opt/devkitpro/devkitARM/bin/arm-none-eabi-gcc -specs=gba.specs -mthumb -mthumb-interwork main.o -o main.elf
