...
# How to compile?
If you had already compiled pokeemerald then you can compile it easily as we need to eun a .sh file to compile.
...
#### To change where to insert it edit offset=790000 to your offset, remember you need to callasm the offset to which you're changing then.
# A screenshow
